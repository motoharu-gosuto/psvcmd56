...
//after this code was confirmed to be ECDSA - correct implementation was moved ti SceMsifEcdsa
//this file is only kept for history
...
//[REVERSED] - [TESTED] (but not with automatic tests)
//size of dst should be block_size0 + block_size1
...
int ecdsa_verify_C8DA14(ecdsa_signature *sig, unsigned char M[0x1C], const ecdsa_point* Qa, const ecdsa_params* params, int key_size_blocks, int key_size_bytes)
{
   ...
   reverse_byte_order_C8E3AA(Qa_unpack[0], Qa->X, key_size_bytes);
   reverse_byte_order_C8E3AA(Qa_unpack[1], Qa->Y, key_size_bytes);
