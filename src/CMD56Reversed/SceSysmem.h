...
{
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_HAS_PADDR = 0x2,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_HAS_ALIGNMENT = 0x4,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_HAS_MIRROR_BLOCKID = 0x40,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_HAS_PID = 0x80,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_HAS_PADDR_LIST = 0x1000,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_PHYCONT = 0x200000,
  SCE_KERNEL_ALLOC_MEMBLOCK_ATTR_ALLOW_PARTIAL_OP = 0x4000000,
};
