...
unsigned char key3_8127FC[0x20] = {0x61, 0x6F, 0xAD, 0xDF, 0x22, 0x04, 0xAC, 0x7A, 0x24, 0x06, 0x4C, 0xCE, 0xD8, 0xCD, 0x88, 0xA0, 
                          0xDE, 0x07, 0xF0, 0x15, 0x43, 0x45, 0x32, 0x7D, 0xBE, 0x4D, 0x49, 0xE1, 0xCA, 0x87, 0x5D, 0x98};

unsigned char key4_81281C[0x20] = {0x5E, 0xF0, 0xE4, 0xAB, 0x2A, 0xCE, 0x26, 0x69, 0x00, 0x96, 0xD9, 0x48, 0xD4, 0xC0, 0x1B, 0x36, 
...
int sub_80E162(unsigned char* dst, int key_size, unsigned char* key)
{
...
int sub_80E43E(unsigned char* dst, int key_size, unsigned char* key, unsigned char* iv)
{
...
int sub_80E4CC(unsigned char* dst, int key_size, unsigned char* key, unsigned char* iv)
{
   unsigned char iv_copy[0x10];
...
int set_dmac5_key_80E26A(unsigned char* key, int nblocks, int slot)
{
   return 0;
}
