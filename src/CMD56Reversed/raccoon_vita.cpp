...
int raccoon_obtain_decryption_partials(unsigned char* dec_partial0, unsigned char* dec_partial1, unsigned char* dec_partial2, unsigned char* dec_partial3)
{
   // choose keys
   ...
   bigmac_decrypt_aes_ecb_0x128_internal_implementation_with_bugs(encrypted_key, KEYSLOT_0x204, KEYSLOT_0x0, 0x10);
   ...
   bigmac_decrypt_aes_ecb_0x128_internal_implementation_with_bugs(output3, input3, KEYSLOT_0x0, 0x10);
